...
import osqlcli.config as config
import osqlcli.telemetry_upload as telemetry_core
...
def _get_osql_cli_version():
    from osqlcli import __version__ as osql_cli_version
    return osql_cli_version
