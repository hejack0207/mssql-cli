...
import time
import unittest
import osqlcli.jsonrpc.contracts.connectionservice as connectionservice
import osqlcli.jsonrpc.contracts.queryexecutestringservice as queryservice
import osqlcli.jsonrpc.jsonrpcclient as json_rpc_client
